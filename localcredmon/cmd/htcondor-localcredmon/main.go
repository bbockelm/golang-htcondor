...
func loadPrivateKey(path string) (interface{}, jwt.SigningMethod, error) {
	//nolint:gosec // User-provided key file path is intentional
	...
	if key, err := x509.ParsePKCS8PrivateKey(block.Bytes); err == nil {
		...
		default:
			return nil, nil, fmt.Errorf("unsupported key type in PKCS8: %T", key)
		}
	}
	...
	return nil, nil, fmt.Errorf("failed to parse private key (tried RSA, ECDSA, PKCS8)")
}
