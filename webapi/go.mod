module github.com/bbockelm/golang-htcondor/webapi

go 1.25.7

require (
	github.com/PelicanPlatform/classad v0.29.5
...
require (
	github.com/PelicanPlatform/classad/collections v0.29.5
...
require (
	github.com/PelicanPlatform/classad/dbrpc v0.29.5
