...
func TestStartupLimitAttributeNames(t *testing.T) {
	...
	expectedAttrs := map[string]string{
		...
		"StartupLimitExpression":       AttrStartupLimitExpr,
		"StartupLimitRateCost":         AttrStartupLimitCostExpr,
		"StartupLimitRateCount":        AttrStartupLimitRateCount,
		"StartupLimitRateWindow":       AttrStartupLimitRateWindow,
		"StartupLimitRateBurst":        AttrStartupLimitBurst,
		"StartupLimitRateBurstMaxCost": AttrStartupLimitMaxBurstCost,
		...
		"StartupLimitLastIgnoredTime":  AttrStartupLimitLastIgnored,
		"StartupLimitIgnoredSources":   AttrStartupLimitIgnoredUsers,
	}
